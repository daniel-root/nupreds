...
urlpatterns = [
    ...
    path('ConfirmarEmprestimo/<int:pk>/<str:tipo>', views.emprestar_user, name='emprestar_user'),
    path('ConfirmarDevolução/<int:pk>/<str:tipo>', views.devolver_user, name='devolver_user'),
